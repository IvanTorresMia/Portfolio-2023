...
const Technologies = () => {
  ...
  return (
    <div
      className="h-vh main-bc d-flex flex-column w-60 m-auto text-center"
      id="tech"
    >
      ...
      {technologies.map((item, i) => (
        <div key={i} className="d-flex p-b-xl">
          <div
            className="icon-section d-flex flex-column"
            style={{ width: "200px" }}
          >
          ...
          <Progress
            ...
            className="text-color-w"
            percent={item.percent}
          />
        </div>
      ))}
      <div className="d-flex flex-column">
        <Text className="text-color-w font-xxl">I've also worked with</Text>

        <Text className="text-color-w">
          Loadash, Express, C#, Entity Framework, Antd Design, Bootstrap,
          Material UI, TypeScript and more...{" "}
        </Text>
      </div>
    </div>
  );
