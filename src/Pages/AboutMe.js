        ...
        <div className='d-flex justify-content-between w-60 m-auto h-vh'>
            ...
            <div className='text-color-w d-flex flex-column text-center p-m'>
                ...
                <Text className='text-color-w font-16'>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit,  <span className="secondary-c">ed do eiusmod tempor incididunt ut </span> labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
                </Text>
            </div>
        </div>
    )
